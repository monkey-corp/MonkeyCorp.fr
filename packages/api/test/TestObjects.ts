...
export namespace CountryObjects {
    export const minimal = {
        id: 1,
...
export namespace HistoryObjects {
    export const minimal = {
        id: 1,
...
export namespace ParagraphObjects {
    export const minimal = {
        id: 2,
        content: 'A minimal paragraph'
    }
}
export namespace PersonObjects {
    export const minimal = {
        id: 2,
        name: 'Minimal',
        surname: 'Person',
